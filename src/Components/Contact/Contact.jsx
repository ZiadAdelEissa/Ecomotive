  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto">
      ...
      <div className="lg:w-1/2 md:w-2/3 mx-auto">
        <form action="mailto:ziadadel6060@gmail.com" method="post" enctype="text/plain"  className="flex flex-wrap m-2">
          ...
          <div className="p-2 w-1/2">
            <div className="relative">
              ...
              <input type="phone" id="phone" name="phone" className="w-full bg-gray-800 bg-opacity-40 rounded border border-gray-700 focus:border-indigo-500 focus:bg-gray-900 focus:ring-2 focus:ring-indigo-900 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
            </div>
          </div>
